...
import { createStore, getAllStores, getStore, calculateCycleBenefits, getStoreData } from '../controllers/store.controller.js'; // Ajusta la ruta según tu estructura de archivos
